...
In the event that there are issues installing via the provided .yml file, you may also try to create your own conda environment that will be miRador ready with the following:  
